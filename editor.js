...
publishBtn.addEventListener('click', () => {
    ...
    //    again use decode uri to decode the URL
...
// here is extract the blog id from the url

// checking for existing blog edits

let blogId = location.pathname.split("/");
blogId.shift();
// add blog id dot shift method to remove first item from the array because first item in the array is empty



// check to the existing blog route
if(blogId[0] != "editor"){
...
// use decode uri method here to decode the url and this way fetch the blog data